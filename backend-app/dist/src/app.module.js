...
exports.AppModule = AppModule = __decorate([
    (0, common_1.Module)({
        imports: [student_module_1.StudentModule, profesor_module_1.ProfesorModule, predmet_module_1.PredmetModule, prisustvo_module_1.PrisustvoModule, cas_module_1.CasModule, typeorm_1.TypeOrmModule.forRoot(typeorm_config_1.typeOrmConfig), auth_module_1.AuthModule, auth_profesor_module_1.AuthProfesorModule, prisustvo_po_casu_module_1.PrisustvoPoCasuModule],
        controllers: [app_controller_1.AppController, student_controller_1.StudentController, profesor_controller_1.ProfesorController, predmet_controller_1.PredmetController, prisustvo_controller_1.PrisustvoController, cas_controller_1.CasController, prisustvo_po_casu_controller_1.PrisustvoPoCasuController],

...
@Module({
  imports: [StudentModule, ProfesorModule, PredmetModule, PrisustvoModule, CasModule,TypeOrmModule.forRoot(typeOrmConfig), AuthModule, AuthProfesorModule, PrisustvoPoCasuModule],
  controllers: [AppController, StudentController, ProfesorController, PredmetController, PrisustvoController, CasController, PrisustvoPoCasuController],
